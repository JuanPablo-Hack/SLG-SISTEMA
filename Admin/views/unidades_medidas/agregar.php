    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-success" style="display: none;" id="success"><b>Felicidades!</b> Has agregado con éxito el unidad de medida.</div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success">Agregar unidad de medida</button>
            </div>
            </form>
        </div>
    </div>
