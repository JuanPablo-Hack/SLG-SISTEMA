...
<body>
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i>Crear tipo servicio</h3>
                <div class="row mt">
                    <!--  DATE PICKERS -->
                    <div class="col-lg-12">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document
                .getElementById("formTipoServicio")
                .addEventListener("submit", formTipoServicio);
        });
        async function formTipoServicio(e) {
            e.preventDefault();
