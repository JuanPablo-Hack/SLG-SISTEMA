...
<body>
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i>Crear presentación de mercancia</h3>
                <div class="row mt">
                    <!--  DATE PICKERS -->
                    <div class="col-lg-12">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document
                .getElementById("formPresentacion")
                .addEventListener("submit", formPresentacion);
        });
        async function formPresentacion(e) {
            e.preventDefault();
            var form = document.getElementById("formPresentacion");
