...
$sql = "SELECT * FROM carga WHERE id='$id_mercancia'";
...
<body>
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i>Editar tipo de carga</h3>
                <div class="row mt">
                    <!--  DATE PICKERS -->
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <form class="form-horizontal style-form" id="formCargaEditar">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document
                .getElementById("formCargaEditar")
                .addEventListener("submit", formCargaEditar);
        });
        async function formCargaEditar(e) {
            e.preventDefault();
            var form = document.getElementById("formCargaEditar");
