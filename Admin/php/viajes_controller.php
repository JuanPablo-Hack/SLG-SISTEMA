...
function agregar_viajelocal($fecha, $tipo_unidad, $unidad, $tipo_servicio, $tipo_carga, $tipo_contenedor, $no_caja, $operador, $dec, $terminal_carga, $p_neto, $p_tara, $p_bruto, $naviera, $patio_destino, $eir, $inicio_estadias, $termino_estadias)
{
    include 'conexion.php';
    subir_imagenes_viajes_locales($fecha);
    $sql = "INSERT INTO `viajes_locales` (`fecha`, `id_tipo_unidad`, `unidad`, `id_tipo_servicio`, `id_tipo_carga`, `id_tipo_contenedor`, `no_contenedores`, `operador`, `dec`, `terminal`, `peso_neto`, `peso_tara`, `peso_bruto`, `destino`, `naviera`, `eir`, `inicio_estadias`, `fin_estadias`) VALUES ('$fecha', '$tipo_unidad', '$unidad', '$tipo_servicio', '$tipo_carga', '$tipo_contenedor', '$no_caja', '$operador', '$dec', '$terminal_carga', '$p_neto', '$p_tara', '$p_bruto', '$patio_destino', '$naviera', '$eir', '$inicio_estadias', '$termino_estadias')";
...
function agregar_viajeforaneo($fecha, $tipo_unidad, $unidad, $tipo_servicio, $tipo_carga, $tipo_contenedor, $no_caja, $operador, $dec, $terminal_carga, $p_neto, $p_tara, $p_bruto, $naviera, $patio_destino, $eir, $instruccion, $inicio_estadias, $termino_estadias, $combustible, $viaticos, $casetas)
{

    include 'conexion.php';
    subir_imagenes_viajes_foraneos($fecha);
    $sql = "INSERT INTO `viajes_foraneos` (`fecha`, `id_tipo_unidad`, `unidad`, `id_tipo_servicio`, `id_tipo_carga`, `id_tipo_contenedor`, `no_contenedores`, `operador`, `dec`, `terminal`, `peso_neto`, `peso_tara`, `peso_bruto`, `destino`, `naviera`, `eir`, `carta_ins`, `inicio_estadia`, `fin_estadia`, `combustible`, `viaticos`, `casetas`) VALUES ('$fecha', '$tipo_unidad', '$unidad', '$tipo_servicio', '$tipo_carga', '$tipo_contenedor', '$no_caja', '$operador', '$dec', '$terminal_carga', '$p_neto', '$p_tara', '$p_bruto', '$patio_destino', '$naviera', '$naviera', '$eir', '$inicio_estadias', '$termino_estadias', '$combustible', '$viaticos', '$casetas')";
    $resultado = $conexion->query($sql);
    if ($resultado) {
        echo 1;
    } else {
