...
$sql = "SELECT * FROM unidades_medidas WHERE id='$id_mercancia'";
...
<body>
                ...
                <div class="row mt">
                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <form class="form-horizontal style-form" id="formEditarUnidadMedida">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document
                .getElementById("formEditarUnidadMedida")
                .addEventListener("submit", formEditarUnidadMedida);
        });
        async function formEditarUnidadMedida(e) {
            e.preventDefault();
            var form = document.getElementById("formEditarUnidadMedida");
            ...
            swalWithBootstrapButtons
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        fetch("php/unidadmedida_controller.php", {
                                method: "POST",
                                body: data,
                            })
