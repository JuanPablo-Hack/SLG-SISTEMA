  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="listar_ingresos.php">Bitacoras de Ingresos</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Bitacora de ingreso de almacen</h3>
        <div class="row mb">
          <a class="btn btn-success" href="./crear_orden.php">Dar de alta ingreso</a> <br>
