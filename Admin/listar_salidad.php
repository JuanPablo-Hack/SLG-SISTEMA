            ...
            <section class="wrapper">
                ...
                <div class="row mb">
                    <div class="content-panel">
                        <a class="btn btn-success" href="./crear_orden2.php">Dar de alta salida</a> <br>
                        <div class="adv-table">
                            <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT * FROM salidas_almacen";
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php
                                                ...
                                                $sql1 = "SELECT * FROM ingreso_almacen WHERE id='" . $mostrar['id_mercancia'] . "'";
                                            ...
                                            <td><?php echo $mostrar['transportista'] ?></td>
                                            <td><?php echo $mostrar['no_sello'] ?></td>
