...
<body>
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i>Crear unidad de medida</h3>
                <div class="row mt">
                    <!--  DATE PICKERS -->
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <form class="form-horizontal style-form" id="formUnidadMedida">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document
                .getElementById("formUnidadMedida")
                .addEventListener("submit", formUnidadMedida);
        });
        async function formUnidadMedida(e) {
            e.preventDefault();
