<?php
  ...
  $sql="SELECT * FROM buque WHERE id='".$id."'";
            ...
            <div class="form-panel">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name='p_bruto' class="form-control" value="<?php echo $peso_bruto;?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Peso Neto</label>
                  <div class="col-sm-4">
                    <input type="text" name='p_neto' class="form-control" value="<?php echo $peso_neto;?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Peso Tara</label>
                  <div class="col-sm-4">
                    <input type="text" name='p_tara' class="form-control" value="<?php echo $peso_tara;?>">
                  </div>
                </div>
                <div class="form-group">
