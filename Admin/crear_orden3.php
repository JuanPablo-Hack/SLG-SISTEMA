...
<body>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <div class="input-group input-large" data-date="01/01/2014" data-date-format="mm/dd/yyyy">
                      <input type="text" class="form-control dpd1" name="inicio_estadia">
                      <span class="input-group-addon">To</span>
                      <input type="text" class="form-control dpd2" name="fin_estadia">
                    </div>
  ...
  <script>
    ...
    async function formViajeLocal(e) {
      e.preventDefault();
      var form = document.getElementById("formViajeLocalx");
