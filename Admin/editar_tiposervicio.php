...
$sql = "SELECT * FROM tipo_servicio WHERE id='$id_mercancia'";
...
<body>
                ...
                <div class="row mt">
                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <form class="form-horizontal style-form" id="formEditarTipoServicio">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document
                .getElementById("formEditarTipoServicio")
                .addEventListener("submit", formEditarTipoServicio);
        });
        async function formEditarTipoServicio(e) {
            e.preventDefault();
            var form = document.getElementById("formEditarTipoServicio");
