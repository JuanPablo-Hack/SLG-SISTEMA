...
<body>
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i>Crear tipo de operación</h3>
                <div class="row mt">
                    <!--  DATE PICKERS -->
                    <div class="col-lg-12">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document
                .getElementById("formTipoOperacion")
                .addEventListener("submit", formTipoOperacion);
        });
        async function formTipoOperacion(e) {
            e.preventDefault();
