...
<body>
    <section id="container">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a href="listar_unidadesmedida.php">Unidades de medida</a></li>
        ...
        <section id="main-content">
            <section class="wrapper">
                <?php include("views/unidades_medidas/listar.php"); ?>
            </section>
        </section>
    ...
    <script src="js/unidades_medidas.js"></script>
