...
<body>
    <section id="container">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a href="listar_tipos_servicios.php">Tipos de servicio</a></li>
        ...
        <section id="main-content">
            <section class="wrapper">
                <?php include("views/tipos_servicios/listar.php"); ?>
            </section>
        </section>
    ...
    <script src="js/tipos_servicios.js"></script>
