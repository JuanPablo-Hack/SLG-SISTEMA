            ...
            <section class="wrapper">
                ...
                <div class="row mb">
                    ...
                    <div class="content-panel">
                        <a href="./crear_tiposervicio.php" class="btn btn-success">Crear tipo de servicios </a> <br><br>
                        <div class="adv-table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href='./editar_tiposervicio.php?id=<?php echo $mostrar['id']  ?>' class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
