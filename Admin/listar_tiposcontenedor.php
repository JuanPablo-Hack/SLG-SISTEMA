...
<body>
    <section id="container">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a href="listar_tiposcontenedor.php">Tipos de contenedor</a></li>
        ...
        <section id="main-content">
            <section class="wrapper">
                <?php include("views/tipos_contenedores/listar.php"); ?>
            </section>
        </section>
    ...
    <script src="js/tipos_contenedores.js"></script>
</body>
