            ...
            <section class="wrapper">
                ...
                <div class="row mb">
                    <div class="content-panel">
                        <a href="./crear_tipooperacion.php" class="btn btn-success">Crear nuevo tipos de operación</a> <br><br>
                        <div class="adv-table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href='./editar_tipooperacion.php?id=<?php echo $mostrar['id']  ?>' class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
