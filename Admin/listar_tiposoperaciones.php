...
<body>
    <section id="container">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a href="listar_tiposoperaciones.php">Tipos de operacion</a></li>
        ...
        <section id="main-content">
            <section class="wrapper">
                <?php include("views/tipos_operaciones/listar.php"); ?>
            </section>
        </section>
    ...
    <script src="js/tipos_operaciones.js"></script>
