...
<body>
                        ...
                        <div class="adv-table">
                            <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM trabajador_proovedor";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="display: none;"><?php echo $mostrar['ine'] ?></td>
                                            <td style="display: none;"><?php echo $mostrar['licencia'] ?></td>
                                            <td>
    ...
    <script type="text/javascript">
        ...
        function fnFormatDetails(oTable, nTr) {
            ...
            sOut += '<tr><td>CURP:</td><td>' + aData[2] + '</td></tr>';
            sOut += '<tr><td>Teléfono:</td><td>' + aData[3] + '</td></tr>';
            sOut += '<tr><td>Ine:</td><td><a href="../Proveedores/operadores/' + aData[3] + '/' + aData[4] + '" target="_blank" rel="noopener noreferrer"><i class="fa fa-file"></a></td></tr>';
            sOut += '<tr><td>Licencia de Conducir:</td><td><a href="../Proveedores/operadores/' + aData[3] + '/' + aData[5] + '" target="_blank" rel="noopener noreferrer"><i class="fa fa-file"></a></td></tr>';
            sOut += '</table>';
