...
switch ($_POST['accion']) {
  case 'agregar':
    ...
    agregar_proveedores($_POST['nombre'], $_POST['email'], $contraseña);
    break;
  case 'editar':
    editar_proveedores($_POST['id'], $_POST['nombre'], $_POST['descripcion']);
    break;
  case 'eliminar':
    eliminar_proveedores($_POST['id']);
    break;
}
function agregar_proveedores($nombre, $email, $contraseña)
{
  enviar_email($email, $contraseña);
  $hash = sha1($contraseña);
  include 'conexion.php';
  $sql = "INSERT INTO proveedores (nombre, email, pwd, datos_cargados) VALUES ('$nombre','$email','$hash',0);";
...
function editar_proveedores($id, $nombre, $email)
{
...
{
  $destinatario = $correo;
  $asunto = "Creación de usuario proveedor en el sistema ERP de SLG";
  $cuerpo = ' 
  <!DOCTYPE html>
  <html
    lang="en"
