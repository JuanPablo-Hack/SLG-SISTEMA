...
function crear_unidad($modelo, $ano, $color, $placas, $no_economico, $capacidad, $tipo_unidad, $tipo_combustible, $serie, $descripcion)
{
    ...
    $sql = "INSERT INTO unidades(modelo,ano,color,placas,noeconomico,capacidad,tipounidad,tipocombustible,serie,descripcion,tipo_unidad) VALUES ('$modelo','$ano','$color','$placas','$no_economico','$capacidad','$tipo_unidad','$tipo_combustible','$serie','$descripcion','1')";
